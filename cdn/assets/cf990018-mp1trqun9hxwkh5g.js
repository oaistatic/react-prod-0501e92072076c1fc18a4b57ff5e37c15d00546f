import{n as e}from"./f025431a-gjb4o5hex8ccu4v5.js";import{K as t,N as n,P as r,s as i,y as a}from"./ebfc007c-eszd98tkywugtxxk.js";import{n as o,r as s,t as c}from"./49213f0f-i0ct5z4vk70x92j0.js";function l(e,t){let{logger:n,encoderPoolSize:r,fontFallback:i}=t instanceof Object&&`debug`in t?{logger:t}:t||{},a=new p(new Worker(URL.createObjectURL(new Blob([`var Rotation = /* @__PURE__ */ ((Rotation2) => {
...
`],{type:`application/javascript`})),{type:`module`}),{wasmUrl:e,logger:n,fontFallback:i}),o=URL.createObjectURL(new Blob([`async function encodeImage(imageData, imageType, quality) {
